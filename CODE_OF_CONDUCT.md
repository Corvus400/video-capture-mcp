...
reported through the repository's security or maintainer contact channels. All
complaints will be reviewed and investigated promptly and fairly.

## Enforcement Guidelines

Maintainers may use the following consequences:

1. Correction: a private written warning that explains the violation.
2. Warning: a public or private warning with consequences for continued
   behavior.
